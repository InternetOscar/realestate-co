...
export default function EnquireNowDialog() {
  ...
  return (
    <>
      <button
        type="button"
        className="col-start-2 col-end-3 bg-black p-4 text-white font-light rounded-md mb-[90px] uppercase text-left"
        onClick={() => setIsOpen(true)}
      >
        Enquire Now!
        <div className="w-5 h-5 mt-[-2px] float-right">
          <svg
        ...
        <div className="fixed inset-0 flex w-screen items-center justify-center p-4 text-lg backdrop-blur-sm">
          <DialogPanel className="max-w-lg space-y-4 bg-white text-black p-12 rounded-xl drop-shadow-lg">
            ...
            <div className="flex gap-4 float-right">
              ...
              <button
                type="button"
                className="border px-4 py-2 bg-black hover:bg-black/80 text-white rounded-md transition-all"
