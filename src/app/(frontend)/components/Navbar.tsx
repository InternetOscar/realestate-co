...
function NavLink({ url, text }: NavLink) {
  ...
  return (
    <li className="flex">
      <Link
        href={url}
        className={`flex items-center mx-4 -mb-1 border-b-2  ${path === url && ''}}`}
      >
        {text}
      </Link>
    </li>
...
export default function Navbar({
  ...
  return (
    <div className="p-4 bg-gradient-to-b from-zinc-100 to-transparent sticky top-0 *:font-sans">
      <div className="w-full inline-flex justify-between h-16 mx-auto px-0">
        ...
        <Link className="hover:*:text-yellow-400 *:transition-all" href="/">
          <h2 className="text-2xl font-bold">Realestate — Company</h2>
        </Link>
        ...
        <ul className="items-stretch hidden lg:flex hover:*:text-yellow-400 *:transition-all *:text-xl">
          ...
          <p>&nbsp; &nbsp; &nbsp;</p>
          <Link href="/lease" className="mt-[-8px] stroke-black hover:stroke-yellow-400">
            <svg
              width="45"
              height="45"
              viewBox="0 0 45 45"
